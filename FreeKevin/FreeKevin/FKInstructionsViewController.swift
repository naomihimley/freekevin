//
//  FKInstructionsViewController.swift
//  FreeKevin
//
...
class FKInstructionsViewController: UIViewController {

    @IBOutlet weak var instructionTextView: UITextView!
    override func viewDidLoad() {
        super.viewDidLoad()
        //Set Instruction Text
        instructionTextView.text = NSLocalizedString("1. Open Settings App \n2. General \n3. Keyboard \n3. Keyboards \n4. Add New Keyboard \n5. Select FakeHax", comment: "Instruction text for how to set up custom keyboards in settings")
